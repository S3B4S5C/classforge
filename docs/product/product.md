...
Las actualizaciones acumulativas anteriores se movieron a `history/product-updates-through-cycle-02.md` para que este documento conserve únicamente la visión y especificación consolidada vigente. El estado de implementación autoritativo se consulta en `../puds/current-status.md` y los casos de uso en `../puds/use-cases.md`.
