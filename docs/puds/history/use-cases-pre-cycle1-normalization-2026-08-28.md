# Historial de especificación y ejecución previo a la normalización del Ciclo 1

> Documento histórico. No representa el estado vigente del proyecto.
>
> Conserva sin eliminar contenido el antiguo `docs/puds/use-cases.md` acumulativo.
> La especificación vigente está en `../use-cases.md` y el estado vigente en `../current-status.md`.
