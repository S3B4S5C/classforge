...
public final class VisionHybridMultiplicityJsonSchema {

    private VisionHybridMultiplicityJsonSchema() {
    }

    public static String jsonForMultiplicityEndpoint(String edgeId, VisionHybridEndpoint endpoint) {
