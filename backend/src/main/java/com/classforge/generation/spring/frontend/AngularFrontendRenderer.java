...
public final class AngularFrontendRenderer {
    ...
    public List<GeneratedFile> render(
        ...
        add(files, "src/app/assistant/assistant.service.ts", assistantService());
        add(files, "src/app/assistant/browser-wav-recorder.service.ts", browserWavRecorder());
        add(files, "src/app/assistant/assistant.component.ts", assistantComponent());
    ...
    private String assistantService() {
        return """
                import { HttpClient } from '@angular/common/http';
                import { inject, Injectable } from '@angular/core';
                import { Observable } from 'rxjs';
    ...
    private String browserWavRecorder() {
        return """
    ...
    private String assistantComponent() {
        return """
                import { Component, inject } from '@angular/core';
                import { FormsModule } from '@angular/forms';
